...
seeder.connect((process.env.MONGODB_URI || "mongodb://localhost/mern"), function() {
  // Load Mongoose models
  seeder.loadModels(["../models/phases.js"]);

  // Clear specified collections
  seeder.clearModels(["Phase"], function() {
    ...
    documents: [
      {
        ...
        resources: [
          ...
          {
            name:
              "HNS Conducts a Situation Analysis - Secondary Data Collection",
            id: "3",
            description:
            ...
            tool: [
              {
                ...
                tool_url: "../assets/phase_1/Proposal_Logframe_Template.docx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                tool_example_title:
                  "Logical Framework - Philippines Delegation",
                tool_example_url:
                  "../assets/phase_1/Proposal_Logframe_Template.docx",
                tool_example_thumb_url: ""
              }
            ]
          },
          {
            ...
            tool: [
              {
                tool_title: "Workplan",
                tool_url: "../assets/phase_1/Proposal_Workplan_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                ...
                tool_example_url:
                  "../assets/phase_1/Proposal_Workplan_Template.xlsx",
                tool_example_thumb_url: ""
              }
            ]
          },
            ...
            tool: [
              {
                ...
                tool_url: "../assets/phase_1/Proposal_Budget_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                ...
                tool_example_url:
                  "../assets/phase_1/Proposal_Budget_Template.xlsx",
                tool_example_thumb_url: ""
              }
            ]
          },
          {
            ...
            tool: [
              {
                tool_title: "Proposal",
                tool_url: "../assets/phase_1/Proposal_Template.doc",
                tool_thumb_url: ""
              },
              {
                tool_title: "Budget",
            ...
            tool_example: [
              {
                ...
                tool_example_url: "../assets/phase_1/Proposal_Template.doc",
                tool_example_thumb_url: ""
              },
              {
            ...
            tool: [
              {
                ...
                tool_url: "../assets/phase_3/Project_M&E_Plan_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                ...
                tool_example_url:
                  "../assets/phase_3/Project_M&E_Plan_Template.xlsx",
                tool_example_thumb_url: ""
              }
            ]
          }
            ...
            tool: [
              {
                ...
                tool_url:
                  "../assets/phase_4/Project_Decisions_Log_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
            ...
            tool: [
              {
                ...
                tool_url: "../assets/phase_4/Project_Issues_Log_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                ...
                tool_example_url:
                  "../assets/phase_4/Project_Issues_Log_Template.xlsx",
                tool_example_thumb_url: ""
              }
            ]
          },
            ...
            tool: [
              {
                ...
                tool_url: "../assets/phase_4/Project_Timesheet_Template.xlsx",
                tool_thumb_url: ""
              }
            ],
            tool_example: [
              {
                ...
                tool_example_url:
                  "../assets/phase_4/Project_Timesheet_Template.xlsx",
                tool_example_thumb_url: ""
              }
            ]
          },
      ...
      },
      {
        ...
        resources: [
          {
            name:
              "HNS Establishes System for Project Monitoring and Evaluation",
            id: "1",
            description:
          ...
          {
            name: "AmRC Reviews Financial and Narrative Reports",
            id: "5",
            description:
      ...
      },
      {
        ...
        resources: [
          {
            name: "HNS Develops Transition Plan (if required)",
            id: "1",
            description:
          ...
          {
            name: "HNS Closes Outstanding Contracts",
            id: "3",
            description:
          ...
          {
            name: "HNS Closes Outstanding Financial Transactions",
            id: "4",
            description:
          ...
          {
            name: "HNS Closes Outstanding Administrative Obligations",
            id: "5",
            description:
          ...
          {
            name: "HNS Communicates Project Closure",
            id: "6",
            description:
